...
<form class="form-horizontal" method="post" action="<?= base_url()?>akun/upload" >
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-5">
        <input class="form-control" name='waktu' placeholder="Waktu kegiatan" type="text" required="required">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-5">
       <input class="form-control" name='tanggal' placeholder="Tanggal kegiatan" type="text"  required="required">
      </div>
    </div>

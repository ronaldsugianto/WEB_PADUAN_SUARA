               <a href="#songlist" class="page-scroll btn btn-xl">Next List</a>
            </div>
        </div>
    </header>
    <!-- Header======================================= -->
...
<!-- ++++============================================ -->
    ...
    <section class="gambar" id="songlist">
<br><br>
<!-- overlay -->
...
<div id="playlist" class="spacer">
  <div class="row">
          ...
          <h3><span class="glyphicon glyphicon-list"></span> TOP 10 </h3>
<iframe width="100%" height="450" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/286752070&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"></iframe>
          </div>
  </div>
</div>
<!-- #playlist Ends -->
...
<div class="row">
  ...
  <!-- pop-->
  <div class="col-sm-3 col-xs-12"><div class="album"><img src="asset/img/songlist/pop.jpg" class="img-responsive" alt="music theme" /><div class="albumdetail"><h5>Music Pop</h5><a href="#" class="listen" data-toggle="modal" data-target="#albumpop"><span class="glyphicon glyphicon-headphones"></span> Listen Song</a>
  </div></div></div>
 ...
 <!-- Anime-->
  ...
  <!-- pop indonesia-->
  <div class="col-sm-3 col-xs-12"><div class="album"><img src="asset/img/songlist/1.jpg" class="img-responsive" alt="music theme" /><div class="albumdetail"><h5>Music Indonesia Pop</h5><a href="#" class="listen" data-toggle="modal" data-target="#albumindonesia"><span class="glyphicon glyphicon-headphones"></span> Listen Song</a></div></div></div>
</div>
</div>
<!-- TOP 10 ends-->

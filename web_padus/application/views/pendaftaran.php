 ...
 <legend>Form Pendaftaran Anggota Baru</legend>
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-5">
        <input class="form-control" id="inputNama" placeholder="Nama Lengkap" type="text" required="required">
      </div>
    </div>

    <div class="form-group">
      <label  for="inputNIM" class="col-lg-2 control-label">Tanggal Lahir</label>
      <div class="col-lg-5">
<div class="row">
...
<option value="2013">2013</option>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-5">
        <input class="form-control" id="inputalamat" placeholder="Alamat rumah" type="text" required="required">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-5">
        <input class="form-control" id="inputNIM" placeholder="NIM" type="text" required="required">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-5">
        <input type="email" class="form-control" id="inputNIM" placeholder="Email Active" type="text" required="required">
      </div>
    </div>
    <div class="form-group">
      <label class="col-lg-2 control-label">Jenis Suara</label>
      <div class="col-lg-10">
        <div class="radio">
          <label>
        ...
        <div class="radio">
          <label>
            <input name="optionsRadios" id="optionsRadios4" value="option4" type="radio">
            Bass
          </label>
        </div>
      </div>
  ...
  <div class="panel-heading">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <div class="checkbox">
          <label>
            <input type="checkbox"> Saya setuju dan ingin bergabung
          </label>
        </div>
    </div>
    <br>
